...

{
  ...
  nixpkgs.overlays = [
     (final: prev: {
       dwm = prev.dwm.overrideAttrs (old: { src = /home/gavin/.config/dwm ; });
     })
  ];
  
  #dwm.override { patches = /home/gavin/Scripts/dwm-alpha-20201019-61bb8b2.diff; }).overrideAttrs (_: { src = /home/gavin/.config/dwm; })
